...
### Branding Update
*   **Back to Portfolio Link:** Added a "Back to Portfolio" link in the navigation bar to direct users to `https://ycbaek.com`.
*   **Footer Update:** The footer has been updated to match the branding of `ycbaek.com`, including the site name and a revised copyright notice.
